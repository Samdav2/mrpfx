...
export default function Community() {
    return (
        <section className="bg-white py-16 lg:py-24 justify-center">
            <div className="container mx-auto px-4 lg:px-8">
                <div className="flex  lg:flex-row items-center gap-12 lg:gap-20 justify-content-center">
                    ...
                    {/* Right Side: content */}
                    <div className="flex-1 w-full pl-0 flex flex-col items-center justify-center">
                        <div className="relative mb-12 w-full max-w-[340px] md:max-w-[420px]">
                            {/* Banner Image Background */}
                            <div className="relative w-full aspect-[3/1] flex items-center pl-10 md:pl-12">
                                <Image
                                    ...
                                    priority
                                />
                                <h2 className="relative z-10 text-2xl lg:text-3xl font-bold text-white leading-tight text-left mt-[45px] ml-[5px]">
                                    Join Our<br />
                                    Community
                                </h2>
                            </div>
